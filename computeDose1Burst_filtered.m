function [DEkilled,idx] = computeDose1Burst_filtered(t,e,etarget,slitFilterCoefs,Ts)
    arguments
      t
      e
      etarget
    ...
    DEkilled = DE;
    DEkilled(killList) = NaN;
    % DEkilled is the DE with the bad data mostly removed
end